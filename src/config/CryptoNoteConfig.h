...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 9602;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(630000000000000);
...
*/
const char GENESIS_COINBASE_TX_HEX[] = "011e01ff000180c0d5f1b49f8f0102fa848955413e55c0d79d1924fc7209562c46a5d30d32c7241133de17e27bfc0621013fd318010f51cb653baa638cd1c8140ca57c01239790fa870c2a0ce56027862f";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1554733544;
...
const uint64_t DEFAULT_MIXIN_V1                              = 3;
...
const char     CRYPTONOTE_NAME[]                             = "NoCoin";
